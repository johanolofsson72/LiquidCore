        ...
        public static class SiteData
        {
            ...
            public static void Delete(SiteModel Details)
            {
                ...
                try
                {
                    ...
                    LiquidCore.Data.SiteData.ResetThis();
            ...
            public static void RecursiveDelete(Int32 Id)
            {
                ...
                try
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        LiquidCore.Data.ObjectData.RecursiveDelete(ParentId);
                    }
                }
                catch (Exception ex)
                {
        ...
        public static class ModDefData
        {
            ...
            public static void Delete(ModDefModel Details)
            {
                ...
                try
                {
                    ...
                    LiquidCore.Data.ModDefData.ResetThis();
                    Details = null;
                }
                catch (Exception ex)
                {
            ...
            public static void LoadAll(ref List<List.Item> _objects, NameValueSet DataFields)
            {
                ...
                try
                {
                    ...
                    if (DataFields["Parameters"] != null && DataFields["Alias"] != null)
                    {
                        ...
                        sSQL.Append("SELECT obd_id FROM obd_objectdata WHERE obd_alias = '" + DataFields["Alias"].ToString() + "' AND obd_deleted = 0 AND (" + sWhere.ToString() + ") ORDER BY sit_id, pag_id, mod_id, sta_id, lng_id, obd_parentid, obd_order");
                    }
        ...
        public static class UserTypeData
        {
            ...
            public static void Delete(UserTypesModel.UserTypeModel Details)
            {
                ...
                try
                {
                    ...
                    LiquidCore.Data.UserTypeData.ResetThis();
                    Details = null;
                }
                catch (Exception ex)
                {
        ...
        public static class RoleData
        {
            ...
            public static void Delete(RolesModel.RoleModel Details)
            {
                ...
                try
                {
                    ...
                    LiquidCore.Data.RoleData.ResetThis();
                    Details = null;
                }
                catch (Exception ex)
                {
        ...
        public static class UserData
        {
            ...
            public static void Delete(UsersModel.UserModel Details)
            {
                ...
                try
                {
                    ...
                    LiquidCore.Data.UserData.ResetThis();
                    Details = null;
                }
                catch (Exception ex)
                {
        ...
        public static class StatusData
        {
            ...
            public static void Delete(StatusModel.ItemModel Details)
            {
                ...
                try
                {
                    ...
                    LiquidCore.Data.StatusData.ResetThis();
                    Details = null;
                }
                catch (Exception ex)
                {
