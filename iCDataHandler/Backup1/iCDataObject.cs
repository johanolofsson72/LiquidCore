...
namespace iConsulting.iCDataHandler
{
	public class iCDataObject : clsConnection, IDisposable  
	{
        ...
        private Boolean             m_OverrideTransaction = false;
		...
		{
            if (System.Configuration.ConfigurationManager.AppSettings["Data.OverrideTransaction"] != null)
                m_OverrideTransaction = Convert.ToBoolean(System.Configuration.ConfigurationManager.AppSettings["Data.OverrideTransaction"].ToString());
