...
namespace LiquidCore
{
    ...
    public class Objects : ObjectsDefinition
    {
        ...
        public class Item : ObjectDefinition
        {
            ...
            public Item() : base() { Init(); }
            public Item(Int32 Id) : base(Id) { Init(); }
    ...
    public class Menu : MenuDefinition
    {
        ...
        public class Item : MenuDefinition.ItemDefinition
        {
            ...
            private void Init()
            {
                ...
                _modules = new Modules(this.SitId, this.Id, 0, true);
            }
    ...
    public class List : ListDefinition
    {
        ...
        private void Init(Int32 SitId, Int32 PagId, Int32 ModId)
        {
            ...
            _pagid = PagId;
            _modid = ModId;
            _settings = new Settings(SitId, PagId, ModId, 0);
        }
        public void CreateSetting(String Name, String Value)
        {
            string FUNCTIONNAME = CLASSNAME + "[Function::CreateSetting]";
    ...
    public class Users : UsersDefinition
    {
        ...
        public class User : UsersDefinition.UserDefinition
        {
            ...
            public User() : base() { Init(); }
            public User(Int32 Id) : base(Id) { Init(); }
    ...
    namespace LiquidCore.Definition
    {
        ...
        public class MenuDefinition : DomainObject, IDomainObject, IDisposable, ICollection<Menu.Item>
        {
            ...
            public class ItemDefinition : DomainObject, IDomainObject, IDisposable
            {
                ...
                void IDomainObject.CreateEntity()
                {
                    LiquidCore.Data.MenuData.Create(Details);
                }
                ...
                void IDomainObject.UpdateEntity()
                {
                    LiquidCore.Data.MenuData.Update(Details);
                }
        ...
        public class ListDefinition : DomainObject, IDomainObject, IDisposable, ICollection<List.Item>
        {
            ...
            public class ItemDefinition : DomainObject, IDomainObject, IDisposable
            {
                ...
                void IDomainObject.CreateEntity()
                {
                    LiquidCore.Data.ListData.Create(Details);
                }
                ...
                void IDomainObject.UpdateEntity()
                {
                    LiquidCore.Data.ListData.Update(Details);
                }

                void IDomainObject.DeleteEntity()
                {
                    LiquidCore.Data.ListData.Delete(Details);
                }
...
namespace LiquidCore
{
    ...
    namespace LiquidCore.Data
    {
        ...
        public static class SiteData
        {
            ...
            public static void Delete(SiteModel Details)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        EventLog.LogEvent("delete_sit_sites(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                        System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_sit_sites(" + Details.Id.ToString() + "));");
                        oDo.ExecuteNonQuery("delete_sit_sites(" + Details.Id.ToString() + ");");
                        if (oDo.HasError)
                            throw new Exception(oDo.GetError);
        ...
        public static class SettingData
        {
            ...
            public static void LoadAll(ref List<Setting> _settings)
            {
                ...
                try
                {
                    ...
                    {
                        StringBuilder sSQL = new StringBuilder();
                        sSQL.Append("SELECT set_id FROM set_settings WHERE set_deleted = 0 ORDER BY sta_id, ");
            ...
            public static void LoadAll(ref List<Setting> _settings, NameValueSet DataFields)
            {
                ...
                try
                {
                    ...
                    if (DataFields["SitId"] != null && DataFields["PagId"] != null && DataFields["ModId"] != null && DataFields["ParentId"] != null)
                    {
                        ...
                        sSQL.Append("SELECT set_id FROM set_settings WHERE sit_id = " + SitId + " AND pag_id = " + PagId + " AND mod_id = " + ModId + " AND set_parentid = " + ParentId + " AND set_deleted = 0 ORDER BY sta_id, lng_id, set_parentid, set_order");
                    }
                    else if (DataFields["Alias"] != null)
                    {
                        PrimaryKey = DataFields["Alias"].ToString();
                        CacheItem = "LiquidCore.Settings.PrimaryKey(Alias(" + PrimaryKey + "))";
                        sSQL.Append("SELECT set_id FROM set_settings WHERE set_alias = '" + PrimaryKey + "' AND set_deleted = 0 ORDER BY sta_id, lng_id, set_parentid, set_order");
                    }
                    else if (DataFields["Pointer"] != null)
                    {
                        ...
                        sSQL.Append("SELECT set_id FROM set_settings WHERE set_pointer = " + PrimaryKey + " AND set_deleted = 0 ORDER BY sta_id, lng_id, set_parentid, set_order");
                    }
                    else
                    {
            ...
            public static void Delete(SettingModel Details)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        EventLog.LogEvent("CALL delete_set_settings(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                        System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_set_settings(" + Details.Id.ToString() + "));");
                        oDo.ExecuteNonQuery("CALL delete_set_settings(" + Details.Id.ToString() + ");");
                        if (oDo.HasError)
                            throw new Exception(oDo.GetError);
        ...
        public static class PageData
        {
            ...
            public static void LoadAll(ref List<Page> _pages, NameValueSet DataFields)
            {
                ...
                try
                {
                    ...
                    if (DataFields["SitId"] != null && DataFields["ParentId"] != null)
                    {
                        ...
                        sSQL.Append("SELECT pag_id FROM pag_pages WHERE sit_id = " + SitId + " AND pag_parentid = " + ParentId + " AND pag_deleted = 0 ORDER BY sit_id, sta_id, lng_id, pag_parentid, pag_order");
                    }
                    else if (DataFields["Alias"] != null)
                    {
                        PrimaryKey = DataFields["Alias"].ToString();
                        CacheItem = "LiquidCore.Pages.PrimaryKey(Alias(" + PrimaryKey + "))";
                        sSQL.Append("SELECT pag_id FROM pag_pages WHERE pag_alias = '" + PrimaryKey + "' AND pag_deleted = 0 ORDER BY sit_id, sta_id, lng_id, pag_parentid, pag_order");
                    }
                    else
                    {
                        LoadAll(ref _pages);
            ...
            public static void Delete(PageModel Details, NameValueSet DataFields)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        if ((bool)DataFields["Recursive"])
                        {
                            EventLog.LogEvent("CALL delete_pag_pages_recursive(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                            System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_pag_pages_recursive(" + Details.Id.ToString() + "));");
                            oDo.ExecuteNonQuery("CALL delete_pag_pages_recursive(" + Details.Id.ToString() + ");");
                            if (oDo.HasError)
                                throw new Exception(oDo.GetError);

                            LiquidCore.Data.PageData.ResetThis();
                            LiquidCore.Data.ModuleData.ResetThis();
                            LiquidCore.Data.ObjectData.ResetThis();
                            LiquidCore.Data.SettingData.ResetThis(); 
                        }
                        else
                        {
                            EventLog.LogEvent("CALL delete_pag_pages(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                            System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_pag_pages(" + Details.Id.ToString() + "));");
                            oDo.ExecuteNonQuery("CALL delete_pag_pages(" + Details.Id.ToString() + ");");
                            if (oDo.HasError)
                                throw new Exception(oDo.GetError);
        ...
        public static class ModuleData
        {
            ...
            public static void Create(ModuleModel Details)
            {
                ...
                try
                {
                    ...
                    sSQL1.Append("INSERT INTO mod_modules (sit_id, pag_id, mde_id, sta_id, lng_id, mod_parentid, mod_order, mod_title, ");
                    ...
                    sSQL1.Append("mod_updateddate, mod_updatedby, mod_hidden, mod_deleted) VALUES ( ");
            ...
            public static void LoadAll(ref List<Module> _modules)
            {
                ...
                try
                {
                    ...
                    {
                        StringBuilder sSQL = new StringBuilder();
                        sSQL.Append("SELECT mod_id FROM mod_modules WHERE mod_deleted = 0 ORDER BY sit_id, pag_id, sta_id, ");
            ...
            public static void LoadAll(ref List<Module> _modules, NameValueSet DataFields)
            {
                ...
                try
                {
                    ...
                    if (DataFields["SitId"] != null && DataFields["GetAggregatableModules"] != null)
                    {
                        ...
                        sSQL.Append("SELECT m.mod_id FROM mod_modules m WHERE m.sit_id = " + SitId + " AND m.mod_id IN ( SELECT mod_id FROM agg_aggregation WHERE agg_deleted = 0 ) AND m.mod_deleted = 0 ORDER BY m.sit_id, m.pag_id, m.sta_id, m.lng_id, m.mod_parentid, m.mod_order");
                    }
                    else if (DataFields["Status"] != null && DataFields["SitId"] != null && DataFields["PagId"] != null && DataFields["ParentId"] != null && DataFields["IncludeAggregated"] != null)
                    {
                        ...
                        if (IncludeAggregated.Equals(0))
                        {
                            ...
                            sSQL.Append("SELECT mod_id FROM mod_modules WHERE sta_id = " + Status + " AND sit_id = " + SitId + " AND pag_id = " + PagId + " AND mod_parentid = " + ParentId + " AND mod_deleted = 0 OR sit_id = " + SitId + " AND sta_id = " + Status + " AND mod_allpages = 1 AND mod_parentid = " + ParentId + " AND mod_deleted = 0 ORDER BY sit_id, pag_id, sta_id, lng_id, mod_parentid, mod_order");
                        }
                        else
                        {
                            CacheItem = "LiquidCore.Modules.PrimaryKeys(Status(" + Status + "), SitId(" + SitId + "), PagId(" + PagId + "), ParentId(" + ParentId + "), IncludeAggregated(" + (IncludeAggregated.Equals(1) ? "true" : "false").ToString() + "))";
                            sSQL.Append("SELECT m.mod_id FROM mod_modules m WHERE m.sta_id = " + Status + " AND m.sit_id = " + SitId + " AND m.pag_id = " + PagId + " AND m.mod_parentid = " + ParentId + " AND m.mod_deleted = 0 OR m.sit_id = " + SitId + " AND m.mod_allpages = 1 AND m.mod_parentid = " + ParentId + " AND m.mod_deleted = 0 OR m.sit_id = " + SitId + " AND m.sta_id = " + Status + " AND m.mod_id IN ( SELECT mod_id FROM agg_aggregation WHERE agg_deleted = 0 AND pag_id = " + PagId + " ) AND m.mod_parentid = " + ParentId + " AND m.mod_deleted = 0 ORDER BY m.sit_id, m.pag_id, m.sta_id, m.lng_id, m.mod_parentid, m.mod_order");
                        }
                    }
                    else if (DataFields["SitId"] != null && DataFields["PagId"] != null && DataFields["ParentId"] != null && DataFields["IncludeAggregated"] != null)
                    {
                        ...
                        if (IncludeAggregated.Equals(0))
                        {
                            ...
                            sSQL.Append("SELECT mod_id FROM mod_modules WHERE sit_id = " + SitId + " AND pag_id = " + PagId + " AND mod_parentid = " + ParentId + " AND mod_deleted = 0 OR sit_id = " + SitId + " AND mod_allpages = 1 AND mod_parentid = " + ParentId + " AND mod_deleted = 0 ORDER BY sit_id, pag_id, sta_id, lng_id, mod_parentid, mod_order");
                        }
                        else
                        {
                            CacheItem = "LiquidCore.Modules.PrimaryKeys(SitId(" + SitId + "), PagId(" + PagId + "), ParentId(" + ParentId + "), IncludeAggregated(" + (IncludeAggregated.Equals(1) ? "true" : "false").ToString() + "))";
                            sSQL.Append("SELECT m.mod_id FROM mod_modules m WHERE m.sit_id = " + SitId + " AND m.pag_id = " + PagId + " AND m.mod_parentid = " + ParentId + " AND m.mod_deleted = 0 OR m.sit_id = " + SitId + " AND m.mod_allpages = 1 AND m.mod_parentid = " + ParentId + " AND m.mod_deleted = 0 OR m.sit_id = " + SitId + " AND m.mod_id IN ( SELECT mod_id FROM agg_aggregation WHERE agg_deleted = 0 AND pag_id = " + PagId + " ) AND m.mod_parentid = " + ParentId + " AND m.mod_deleted = 0 ORDER BY m.sit_id, m.pag_id, m.sta_id, m.lng_id, m.mod_parentid, m.mod_order");
                        }
                    }
                    ...
                    else if (DataFields["Alias"] != null)
                    {
                        ...
                        sSQL.Append("SELECT mod_id FROM mod_modules WHERE mod_alias = '" + PrimaryKey + "' AND mod_deleted = 0 ORDER BY sit_id, pag_id, sta_id, lng_id, mod_parentid, mod_order");
                    }
                    else
                    {
            ...
            public static void Delete(ModuleModel Details, NameValueSet DataFields)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        if ((bool)DataFields["Recursive"])
                        {
                            EventLog.LogEvent("CALL delete_mod_modules_recursive(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                            System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_mod_modules_recursive(" + Details.Id.ToString() + "));");
                            oDo.ExecuteNonQuery("CALL delete_mod_modules_recursive(" + Details.Id.ToString() + ");");
                            if (oDo.HasError)
                                throw new Exception(oDo.GetError);
                        ...
                        {
                            EventLog.LogEvent("CALL delete_mod_modules(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                            System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_mod_modules(" + Details.Id.ToString() + "));");
                            oDo.ExecuteNonQuery("CALL delete_mod_modules(" + Details.Id.ToString() + ");");
                            if (oDo.HasError)
                                throw new Exception(oDo.GetError);
            ...
            public static void SortAll()
            {
                ...
                try
                {
                    Int32 Order = (Int32)OrderMinMax.Min;
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT mod_id FROM mod_modules WHERE mod_deleted = 0 ORDER BY sit_id, pag_id, sta_id, lng_id, mod_parentid, mod_revision, mod_contentpane, mod_order");
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, false))
                    {
                        DataTable dt = oDo.GetDataTable(sSQL.ToString());
                        if (oDo.HasError)
        ...
        public static class ObjectData
        {
            ...
            public static void Delete(ObjectModel Details)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        EventLog.LogEvent("CALL delete_obd_objectdata(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                        System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_obd_objectdata(" + Details.Id.ToString() + "));");
                        oDo.ExecuteNonQuery("CALL delete_obd_objectdata(" + Details.Id.ToString() + ");");
                        if (oDo.HasError)
                            throw new Exception(oDo.GetError);
        ...
        public static class ModelData
        {
            ...
            public static void Delete(ModelModel Details)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        EventLog.LogEvent("CALL delete_mdl_model(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                        System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_mdl_model(" + Details.Id.ToString() + "));");
                        oDo.ExecuteNonQuery("CALL delete_mdl_model(" + Details.Id.ToString() + ");");
                        if (oDo.HasError)
                            throw new Exception(oDo.GetError);
        ...
        public static class ModelItemData
        {
            ...
            public static void Delete(ModelItemModel Details)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        EventLog.LogEvent("CALL delete_mdi_modelitems(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                        System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_mdi_modelitems(" + Details.Id.ToString() + "));");
                        oDo.ExecuteNonQuery("CALL delete_mdi_modelitems(" + Details.Id.ToString() + ");");
                        if (oDo.HasError)
                            throw new Exception(oDo.GetError);
        ...
        public static class ModDefData
        {
            ...
            public static void Delete(ModDefModel Details)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        EventLog.LogEvent("delete_mde_moduledefinitions(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                        System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_mde_moduledefinitions(" + Details.Id.ToString() + "));");
                        oDo.ExecuteNonQuery("delete_mde_moduledefinitions(" + Details.Id.ToString() + ");");
                        if (oDo.HasError)
                            throw new Exception(oDo.GetError);
        ...
        public static class CacheData
        {
            ...
            public static void Insert(String CacheItem, Int32[] i)
            {
                if (HttpContext.Current != null && CacheTimeOut > 0)
                {
                    ...
                    {
                        Reset(CacheItem);
                        HttpContext.Current.Cache.Insert(CacheItem, i, null, DateTime.Now.AddMinutes(CacheTimeOut), TimeSpan.Zero, System.Web.Caching.CacheItemPriority.High, null);
        ...
        public static class MenuData
        {
            ...
            public static void Create(MenuModel.ItemModel Details)
            {
                string FUNCTIONNAME = CLASSNAME + "[Function::Create]";
                try
                {
            ...
            public static void LoadAll(ref List<Menu.Item> _pages)
            {
                ...
                try
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        Menu.Item p = new Menu.Item(Convert.ToInt32(dr["pag_id"].ToString()));
                        _pages.Add(p);
                    }
                }
                catch (Exception ex)
            ...
            public static void Update(MenuModel.ItemModel Details)
            {
                string FUNCTIONNAME = CLASSNAME + "[Function::Update]";
                try
                {
            ...
            private static Int32[] GetAuthorizedEditRoles(Int32 Id)
            {
                string FUNCTIONNAME = CLASSNAME + "[Function::GetAuthorizedEditRoles]";
                Int32[] Roles;
                DataTable dt = null;
        ...
        public static class ListData
        {
            ...
            public static void Create(ListModel.ItemModel Details)
            {
                string FUNCTIONNAME = CLASSNAME + "[Function::Create]";
                try
                {
            ...
            public static void Load(ModelObject Details, NameValueSet DataFields)
            {
                ...
                {
                    System.Data.DataTable dt = null;
                    String CacheItem = "LiquidCore.List.Item.Id(" + DataFields["Id"].ToString() + ")";
                    if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                    if (dt == null)
                    {
                        StringBuilder sSQL = new StringBuilder();
            ...
            public static void LoadAll(ref List<List.Item> _objects)
            {
                ...
                try
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        List.Item o = new List.Item(Convert.ToInt32(dr["obd_id"].ToString()));
                        _objects.Add(o);
                    }
                }
                catch (Exception ex)
            ...
            public static void LoadAll(ref List<List.Item> _objects, NameValueSet DataFields)
            {
                ...
                try
                {
                    ...
                    if (DataFields["SitId"] != null && DataFields["PagId"] != null && DataFields["ModId"] != null && DataFields["MaxRowCount"] != null && DataFields["StartDate"] != null && DataFields["EndDate"] != null)
                    {
                        String SitId = DataFields["SitId"].ToString();
                        String PagId = DataFields["PagId"].ToString();
                        String ModId = DataFields["ModId"].ToString();
                        ...
                        sSQL.Append("SELECT TOP(" + MaxRowCount + ") obd_id FROM obd_objectdata WHERE sit_id = " + SitId + " AND pag_id = " + PagId + " AND mod_id = " + ModId + " AND obd_updateddate <= '" + EndDate + "' AND obd_updateddate >= '" + StartDate + "' AND obd_deleted = 0 ORDER BY sit_id, pag_id, mod_id, sta_id, lng_id, obd_parentid, obd_order");
                    }
                    else if (DataFields["SitId"] != null && DataFields["PagId"] != null && DataFields["MaxRowCount"] != null && DataFields["StartDate"] != null && DataFields["EndDate"] != null)
                    {
                        ...
                        sSQL.Append("SELECT TOP(" + MaxRowCount + ") obd_id FROM obd_objectdata WHERE sit_id = " + SitId + " AND pag_id = " + PagId + " AND obd_updateddate <= '" + EndDate + "' AND obd_updateddate >= '" + StartDate + "' AND obd_deleted = 0 ORDER BY sit_id, pag_id, mod_id, sta_id, lng_id, obd_parentid, obd_order");
                    }
                    else if (DataFields["SitId"] != null && DataFields["MaxRowCount"] != null && DataFields["StartDate"] != null && DataFields["EndDate"] != null)
                    {
                        ...
                        sSQL.Append("SELECT TOP(" + MaxRowCount + ") obd_id FROM obd_objectdata WHERE sit_id = " + SitId + " AND obd_updateddate <= '" + EndDate + "' AND obd_updateddate >= '" + StartDate + "' AND obd_deleted = 0 ORDER BY sit_id, pag_id, mod_id, sta_id, lng_id, obd_parentid, obd_order");
                    }
                    else if (DataFields["SitId"] != null && DataFields["PagId"] != null && DataFields["ModId"] != null)
                    {
                        ...
                        sSQL.Append("SELECT obd_id FROM obd_objectdata WHERE sit_id = " + SitId + " AND pag_id = " + PagId + " AND mod_id = " + ModId + " AND obd_deleted = 0 ORDER BY sit_id, pag_id, mod_id, sta_id, lng_id, obd_parentid, obd_order");
                    }
                    else if (DataFields["Alias"] != null)
                    {
                        PrimaryKey = DataFields["Alias"].ToString();
            ...
            public static void Update(ListModel.ItemModel Details)
            {
                string FUNCTIONNAME = CLASSNAME + "[Function::Update]";
                try
                {
            ...
            public static void Delete(ListModel.ItemModel Details)
            {
                string FUNCTIONNAME = CLASSNAME + "[Function::Delete]";
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        ...
                        LiquidCore.Data.ListData.ResetThis();
                        LiquidCore.Data.SettingData.ResetThis(); 
                    }
                    Details = null;
                }
            ...
            public static void ResetThis()
            {
                ...
                try
                {
                    CacheData.Reset("LiquidCore.List");
                }
                catch (Exception ex)
                {
                    Error.Report(ex, FUNCTIONNAME, "");
            ...
            public static void SortAll()
            {
                ...
                try
                {
                    Int32 Order = (Int32)OrderMinMax.Min;
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT obd_id FROM obd_objectdata WHERE obd_deleted = 0 ORDER BY sit_id, pag_id, mod_id, sta_id, lng_id, obd_parentid, obd_alias, obd_order");
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, false))
                    {
                        DataTable dt = oDo.GetDataTable(sSQL.ToString());
                        if (oDo.HasError)
        ...
        public static class UserTypeData
        {
            ...
            public static void Delete(UserTypesModel.UserTypeModel Details)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        EventLog.LogEvent("CALL delete_ust_usertypes(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                        System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_ust_usertypes(" + Details.Id.ToString() + "));");
                        oDo.ExecuteNonQuery("CALL delete_ust_usertypes(" + Details.Id.ToString() + ");");
                        if (oDo.HasError)
                            throw new Exception(oDo.GetError);
        ...
        public static class RoleData
        {
            ...
            public static void Delete(RolesModel.RoleModel Details)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        EventLog.LogEvent("CALL delete_rol_roles(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                        System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_rol_roles(" + Details.Id.ToString() + "));");
                        oDo.ExecuteNonQuery("CALL delete_rol_roles(" + Details.Id.ToString() + ");");
                        if (oDo.HasError)
                            throw new Exception(oDo.GetError);
        ...
        public static class UserData
        {
            ...
            public static void Create(UsersModel.UserModel Details)
            {
                ...
                try
                {
                    ((UsersModel.UserModel)Details).Order = (Int32)OrderMinMax.Max;
            ...
            public static void Delete(UsersModel.UserModel Details)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        EventLog.LogEvent("CALL delete_usr_users(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                        System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_usr_users(" + Details.Id.ToString() + "));");
                        oDo.ExecuteNonQuery("CALL delete_usr_users(" + Details.Id.ToString() + ");");
                        if (oDo.HasError)
                            throw new Exception(oDo.GetError);
        ...
        public static class StatusData
        {
            ...
            public static void Delete(StatusModel.ItemModel Details)
            {
                ...
                try
                {
                    using (iConsulting.iCDataHandler.iCDataObject oDo = new iConsulting.iCDataHandler.iCDataObject(System.Configuration.ConfigurationManager.AppSettings["Data.DataSource"].ToString(), System.Configuration.ConfigurationManager.AppSettings["Data.ConnectionString"].ToString(), false, true, true))
                    {
                        EventLog.LogEvent("CALL delete_sta_status(" + Details.Id.ToString() + ");", FUNCTIONNAME, String.Empty);
                        System.Diagnostics.Debug.WriteLine("oDo.ExecuteNonQuery(delete_sta_status(" + Details.Id.ToString() + "));");
                        oDo.ExecuteNonQuery("CALL delete_sta_status(" + Details.Id.ToString() + ");");
                        if (oDo.HasError)
                            throw new Exception(oDo.GetError);
